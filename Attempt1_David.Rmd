...
Data imbalanced. Only 2% Y.  Consider up or down sampling in train set.
...
## convet to tidy format (maybe a bad idea not sure)


```{r}


model_data_tidy <- model_data %>% rename(PAY_1 = PAY_0)
